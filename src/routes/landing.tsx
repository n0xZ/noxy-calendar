		...
		<>
			<header className="p-6 ">
				<nav className="container flex flex-row items-center justify-between max-w-4xl mx-auto text-lg ">
					...
					<NavLink to="/login">Empieza ya!</NavLink>
				</nav>
			</header>
			<main className="container flex flex-col justify-center h-screen max-w-4xl mx-auto space-y-5" >
				...
				<p className='text-center opacity-70'>En Noxy - calendar, podés definir tus recordatorios de todo tipo, y previo a su fecha máxima, recibirás una notificación del mísmo.</p>
				<NavLink
					to="/login"
